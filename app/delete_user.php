...
if(!empty($_POST)){
    ...
    deleteAccount($email_address, $password, $error_message, $delete_message);
}
?>
...
<tr><td>メールアドレス</td><td><input type="text" name="<?= POST_LOGIN_EMAIL_KEY ?>"></td></tr>
<tr><td>パスワード</td><td><input type="password" name="<?= POST_LOGIN_PASSWORD_KEY ?>"></td></tr>
